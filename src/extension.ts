...
export function activate(context: ExtensionContext) {
    ...
    let providerRegistration = workspace.registerTextDocumentContentProvider(markdownScheme, dfmProcess.provider);
    let tokenTreeProviderRegister = workspace.registerTextDocumentContentProvider(tokenTreeScheme, tokenTreeProcess.provider);
    ...
    context.subscriptions.push(providerRegistration, tokenTreeProviderRegister);
